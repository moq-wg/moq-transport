...
`Largest Object` to create this filter.  If it chooses the previous value, the
current Object passes the Latest Object filter, and it MUST be delivered
starting from the beginning. Note that due to network reordering or
