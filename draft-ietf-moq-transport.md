...
of buffered content that has not been consumed by the application yet.
...
appropriate Status Code. The following Status Code mappings are RECOMMENDED:
...
* Current Subscribe Request ID:
  ...
  PUBLISH for the target Track and MUST NOT modify any existing subscription
  state.

* Target Track Namespace and Target Track Name:
